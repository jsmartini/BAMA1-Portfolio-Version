...
// great i2c library sourced from:
...
inline int i2c_init(const char* i2c_fname) {
    int i2c_fd;
...
inline int i2c_write(int i2c_fd, u8 slave_addr, u8 reg, u8 data) {
    int retval;
    u8 outbuf[2];
...
inline int i2c_read(int i2c_fd, u8 slave_addr, u8 reg, u8 *result) {
    int retval;
    u8 outbuf[1], inbuf[1];
